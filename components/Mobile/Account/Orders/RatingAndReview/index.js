        ...
        return (
            <React.Fragment>
                ...
                {this.state.completed ? (
                    ...
                    <React.Fragment>
                        <img src="/assets/img/various/review-bg.png" alt="review" className="img-fluid review-screen-bg" />

                        <div className="block-content block-content-full pt-80 px-15">
                            <form className="rating-form">
                                <div className="form-group pt-30 mb-0">
                                    <label className="col-12 text-muted">{localStorage.getItem("rarModDeliveryRatingTitle")}</label>
                                ...
                                <div className="form-group mb-0">
                                    <label className="col-12 text-muted">{localStorage.getItem("rarModRestaurantRatingTitle")}</label>
                                    <div className="col-md-9 pb-5">
                                        <StarRatingComponent
                                ...
                                <div className="form-group mb-0">
                                    <label className="col-12 text-muted">{localStorage.getItem("rarReviewBoxTitle")}</label>
                                    <div className="col-md-9 pb-5">
                                        <textarea
